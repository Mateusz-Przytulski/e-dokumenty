        ...
        if(is_uploaded_file($_FILES['plik']['tmp_name'])) {
            ...
            try {
                ...
                if ($polaczenie->connect_errno != 0) {
                    ...
                    if ($wszystko_OK == true) {
                        if ($polaczenie->query("INSERT INTO dokument VALUES (NULL, '$idzapis', '$nazwa_dokumentu Stworzony przez firmę','$zmienna', '$imie', '$drugie_imie', '$nazwisko', '$nazwa_firmy','$email', '$telefon', '$data_urodzenia', '$kraj', '$miasto', '$adres', '$kod_pocztowy', '$pesel_nip', '$regon', 0)")) {
