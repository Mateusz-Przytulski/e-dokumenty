...
if ($zmieniono==true)
{
    header('Location: company_your_data.php');
}
    ...
    <form method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                <label>Nazwa firmy</label><img src="css/img/question-mark.png" alt="" width="15" data-toggle="tooltip" data-html="true" title="<b>Nazwa firmy:</b> <br/> Proszę podać nazwę firmy">
                ...
                ?>" id="nazwafirm" onkeyup="nazwafir(this.value)" onkeydown="return nazwafirma(event);" name="nazwafirmy" placeholder="Nazwa Firmy" />
