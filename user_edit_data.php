...
if ($zmieniono==true)
{
    header('Location: user_your_data.php');
}
    ...
    <form method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                ?>" name="imie" id="imie" onkeydown="return imieUzytk(event);" onkeyup="imieUzyt(this.value)" placeholder="Imię" />
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" value="<?php
                if (isset($_SESSION['fr_drugieimie']))
                {
                    echo $_SESSION['fr_drugieimie'];
                    unset($_SESSION['fr_drugieimie']);
                }
                ?>" id="drugieimie" onkeydown="return drugieimieUzytk(event);" onkeyup="drugieimieUzyt(this.value)" name="drugieimie" placeholder="Drugie imię" />
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                ?>" id="nazwisko" onkeydown="return nazwiskoUzytk(event);" onkeyup="nazwiskoUzyt(this.value)" name="nazwisko" placeholder="Nazwisko" />
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
                <label>Pesel</label><img src="css/img/question-mark.png" alt="" width="15" data-toggle="tooltip" data-html="true" title="<b>Pesel powinien składać się:</b> <br/> z jedynastu cyft">
                <input type="text" maxlength="11" class="form-control" value="<?php
                if (isset($_SESSION['fr_pesel']))
                {
                    echo $_SESSION['fr_pesel'];
                    unset($_SESSION['fr_pesel']);
                }
                ?>" id="pesel" onkeydown="return (event.ctrlKey||event.altKey||(47<event.keyCode&&event.keyCode<58&&event.shiftKey==false)||(95<event.keyCode&&event.keyCode<106)||(event.keyCode==8)||(event.keyCode==9)||(event.keyCode>34&&event.keyCode<40)||(event.keyCode==46))" onkeyup="peselUzyt(this.value)" name="pesell" placeholder="Pesel" />
            ...
            <div class="form-group col-md-4">
                <label>Data urodzenia</label><img src="css/img/question-mark.png" alt="" width="15" data-toggle="tooltip" data-html="true" title="<b>Data urodzenia:</b> <br/> Podaj swoją datę urodzenia">
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
                <label>Adres zamieszkania</label><img src="css/img/question-mark.png" alt="" width="15" data-toggle="tooltip" data-html="true" title="<b>Adres instytucji:</b> <br/> proszę podać adres zamieszkania">
                <input type="text" class="form-control" value="<?php
...
<script>
    function imieUzyt(str) {
        ...
        if(!str.match('^[a-zA-Ząćęłńóśźż]+$') | str.length == 0){
            if(str.length == 0){
                document.getElementById("edytujimie").innerHTML = "Pole nie jest wymagane";
            }
            else{
...
<script>
    function drugieimieUzyt(str) {
        ...
        if(!str.match('^[a-zA-Ząćęłńóśźż]+$') | str.length == 0){
            if(str.length == 0){
                document.getElementById("edytujdrugieimie").innerHTML = "Pole nie jest wymagane";
            }
            else {
...
<script>
    function peselUzyt(str) {
        if (!str.match("^[0-9]{11}") | str.length == 0) {
            if(str.length == 0){
                document.getElementById("edytujpesel").innerHTML = "Pole nie jest wymagane";
            }
            else{
